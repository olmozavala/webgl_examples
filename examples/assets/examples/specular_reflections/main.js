...
function initTextures() {
    ...
    earthTexture.image.src = "assets/img/earth.jpg";
    ...
    galvanizedTexture.image.src = "assets/img/metal.jpg";
}
...
function loadTeapot() {
    ...
    request.open("GET", "assets/examples/specular_reflections/Teapot.json");
